...
public class RoomDetailsPresenterTest extends AndroidTestCase {
...
//  @Mock
//  private RoomModelDataMapper mockRoomModelDataMapper;

  @Override protected void setUp() throws Exception {
    super.setUp();
    MockitoAnnotations.initMocks(this);
//    roomPresenter = new RoomPresenter(mockGetUserDetailsUseCase,
//            mockRoomModelDataMapper);
  ...
  public void testUserDetailsPresenterInitialize() {
    ...
    roomPresenter.initialize(FAKE_USER_ID);

    verify(mockRoomView).hideRetry();
    verify(mockRoomView).showLoading();
